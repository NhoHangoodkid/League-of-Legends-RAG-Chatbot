"""
Parent-chunk generator for the two-tier retrieval pattern.
...
def get_group_key(meta: Dict[str, Any]) -> str:
...
def get_scope_label(meta: Dict[str, Any]) -> str:
...
def create_parent_chunks(leaf_chunks: List[Dict[str, Any]], max_tokens: int = PARENT_MAX_TOKENS) -> List[Dict[str, Any]]:
    """

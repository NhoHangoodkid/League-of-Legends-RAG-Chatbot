"""
analyze_structure.py - Structure analyser for the RAG preprocessing pipeline.
...
python src/chunking/analyze_structure.py output/cleaned.json output/structured.json --category general
"""
...
def detect_block_type(text, heading, is_table, doc_category):
    """
...
def parse_document(data, doc_category="general"):
    """
...
def make_exercise_key(chapter, section):
...
def link_exercises_to_answers(blocks):
